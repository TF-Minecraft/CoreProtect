...
public class SystemUtils {
    ...
    private static boolean testMode = Boolean.getBoolean("net.tfminecraft.coreprotect.test");
    ...
    private static boolean isLog4jDisabled() {
        return Boolean.getBoolean("log4j2.disable") || Boolean.getBoolean("net.tfminecraft.coreprotect.disable.log4j") || System.getProperty("log4j.configurationFile", "").contains("no-log4j2.xml");
    }
}
