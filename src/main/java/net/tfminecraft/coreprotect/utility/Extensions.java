...
public class Extensions {
    ...
    public static void runDatabaseMigration(String command, CommandSender user, String[] argumentArray) {
        try {
            Class<?> patchClass = Class.forName("net.tfminecraft.coreprotect.utility.extensions.DatabaseMigration");
    ...
    private static void invokeBackgroundService(String methodName) {
        try {
            Class<?> serviceClass = Class.forName("net.tfminecraft.coreprotect.utility.extensions.BackgroundService");
