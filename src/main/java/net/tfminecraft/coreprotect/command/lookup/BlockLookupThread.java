...
import net.tfminecraft.coreprotect.database.lookup.BlockLookup;
import net.tfminecraft.coreprotect.database.lookup.InteractionLookup;
import net.tfminecraft.coreprotect.database.lookup.SignMessageLookup;
