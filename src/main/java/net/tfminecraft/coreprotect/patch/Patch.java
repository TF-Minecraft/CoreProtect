package net.tfminecraft.coreprotect.patch;
        ...
        if (pluginFile.getPath().endsWith(".jar")) {
            try (JarInputStream jarInputStream = new JarInputStream(new FileInputStream(pluginFile))) {
                while (true) {
                    ...
                    if (className.startsWith("net/tfminecraft/coreprotect/patch/script/__") && className.endsWith(".class")) {
            ...
            for (String patchData : patches) {
                ...
                if (performPatch) {
                    ...
                    try {
                        ...
                        if (continuePatch()) {
                            Class<?> patchClass = Class.forName("net.tfminecraft.coreprotect.patch.script.__" + patchData.replaceAll("\\.", "_"));
